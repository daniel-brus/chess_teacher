"""Thin CLI: offline user finetune + frozen hash-split val eval (no DB write).
...
from chess_teacher.pipelines.neural_network.offline_user import main_finetune_eval as main
